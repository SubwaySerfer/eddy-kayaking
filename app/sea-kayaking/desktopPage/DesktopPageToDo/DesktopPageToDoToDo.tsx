...
import "./DesktopPageToDo.scss";

const DesktopPageToDo = () => {
  return (
    <section className="desktopPageseatoDo">
      <div className="desktopPageseatoDo__text">
        <h3 className="desktopPageseatoDo__title">WHAT WE'LL DO</h3>
        <ul className="desktopPageseatoDo__list">
          <li>
      ...
      <div className="desktopPageseatoDo__image">
        <img
...
export default DesktopPageToDo;
